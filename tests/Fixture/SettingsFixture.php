...
class SettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'value' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'collate' => null],
        ...
        '_indexes' => [
            'settings_key_index' => ['type' => 'index', 'columns' => ['key'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2018-02-11 19:30:30',
            'modified' => '2018-02-11 19:30:30'
        ],
    ];
}
